...
#----------------/////////////////////// Salas modifications
OPT   +=  -DGRAVITY_GALAXY # # Check which gravtree.c file is active!! 
#OPT   +=  -DDRIVING
#OPT   +=  -DEXTERNALPRESSURE

#OPT   +=  -DTURB_FILES
#OPT   +=  -DADD_VAZQUEZ_COOLING
...
#--------------------------------------- Adjust settings for target computer -mcmodel=medium
...
ifeq ($(SYSTYPE),"Hoffman2")
CC       =  mpiicc
OPTIMIZE =  -O3 -Wall -funroll-loops
GSL_INCL =  -I/u/home/j/jesusms0/gsl_install/include
GSL_LIBS =  -L/u/home/j/jesusms0/gsl_install/lib
FFTW_INCL=  -I/u/home/j/jesusms0/fftw_install/include
FFTW_LIBS=  -L/u/home/j/jesusms0/fftw_install/lib
#FFTW_INCL = -I/u/home/f/fmarinac/fftw2/include
#FFTW_LIBS = -L/u/home/f/fmarinac/fftw2/lib
MPICHLIB = # -L/u/local/compilers/intel-cs/2013.0.028/mpi/intel64/lib
HDF5INCL = -I/u/local/apps/hdf5/1.10.5/intel-18.0.3/include -DH5_USE_16_API
HDF5LIB  = -L/u/local/apps/hdf5/1.10.5/intel-18.0.3/lib -lhdf5 -lz -lhdf5_hl -lm -static-intel
OPT   +=  -DHOFFMAN2
endif
...
CC       =  mpicc
OPTIMIZE =  -O3 -xHOST
GSL_INCL = -I/home/jesusms/gsl_install/include 
GSL_LIBS = -L/home/jesusms/gsl_install/lib
FFTW_INCL= -I/home/jesusms/fftw_install/include
FFTW_LIBS= -L/home/jesusms/fftw_install/lib
MPICHLIB = 
#HDF5INCL = -I/opt/hdf5/intel/mvapich2_ib/include
#HDF5LIB  = -L/opt/hdf5/intel/mvapich2_ib/lib
OPT   +=  -DCOMET
endif
...
OBJS   = main.o  run.o  predict.o begrun.o endrun.o global.o  \
	 ...
	 gravtree_zhao2.o hydra.o  driftfac.o  \
	 domain.o  allvars.o potential.o  \
         forcetree.o   peano.o gravtree_forcetest.o \
	 pm_periodic.o pm_nonperiodic.o longrange.o Salas_addition/read_turbulence.o \
	 Salas_addition/ran3.o Salas_addition/trilinear_box.o 
