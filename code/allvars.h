...
#define cloud_radius 4.0   ///half box size 1 grid
#define galactic_radius 512.0 ///// edge of the box = half box size GC simulation
#define delta ( 2.0*cloud_radius/128.0 ) ///2*cloud_radius/grid_size-1   "resolution"
#define dim_turb 3
#define size_turb (grid_size*grid_size*grid_size)
#define sec2 (3*size_turb) //// 3* 128^3
#define number_of_grids (512 / 4) /// 2*galactic_radius / 2*cloud_radius

///////////////// TURBULENT FILES HOLDER ARRAY /////////////////
#define seed_ran3 -1129970
...
// #define adisk 1.0   /// parameters of galactic potential
// #define abar 0.75
// #define cbar 0.75
// #define cdisk 0.71
// #define R_diskbar 90.0 //// in pc
// #define R_cluster 2.0 //// in pc
// #define V0_cluster 98.6 //// in km/s
// #define V0_disk_bar 190.0  /// in km/s
 
 #define msun (2.0e33) //grams
 #define mbh (4.0e6)*msun // grams
 #define mbh_msun (4.0e6) ///msun
